...
def build_vision_tower(vision_tower_cfg, **kwargs):
    vision_tower = "checkpoints/LLaMA-VID-7B/LAVIS/eva_vit_g.pth"
    image_processor = getattr(vision_tower_cfg, 'image_processor', getattr(vision_tower_cfg, 'image_processor', ""))
