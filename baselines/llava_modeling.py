...
class LLaVA(ViLLMBaseModel):
    def __init__(self, model_args):
        ...
        print(self.device)
        self.tokenizer, self.model, self.image_processor, _ = load_pretrained_model(self.model_path, None, model_name, load_8bit, load_4bit, device_map=self.device, cache_dir=cache_dir)
